...
(function ($) {
	...
	$.sceditor.locale["es"] = {
		...
		"No URL given": "Debe ingresar una URL",
		"An error occured when uploading the file. Only images can be uploaded (jpg, png, gif, bmp, svg)": "Ocurri\u00f3n un error al cargar el archivo. Solo pueden cargarse imagenes (jpg, png, gif, bmp, svg)",
